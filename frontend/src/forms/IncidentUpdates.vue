<template>
  <div class="card-body pt-3">
    <div
      ...
      class="alert alert-link text-danger"
    >
    ...
    <form
      class="row"
      @submit.prevent="createIncidentUpdate"
    >
      <div class="col-12 col-md-3 mb-3 mb-md-0">
        <select
          v-model="incident_update.type"
          class="form-control"
        >
      ...
      <div class="col-12 col-md-7 mb-3 mb-md-0">
        <input
          id="message"
          v-model="incident_update.message"
          name="description"
          class="form-control"
          required
        >
      ...
      <div class="col-12 col-md-2">
        <button
          ...
          @click.prevent="createIncidentUpdate"
        >
          Add
        </button>
      </div>
